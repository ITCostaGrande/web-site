...
<table width="934" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php 
        ...
        <tr class="brillo">
          ...
          <td width="125"><a href="ver_sliders.php?recordID=<?php echo $row['Id']; ?>" onclick="valida();"><img src="../sliders_save/<?php echo $row['Imagen']; ?>" width="130" height="120" border="1" /></a></td>
          ...
          <td>
            <div align="center"><a href="modificar_sliders.php?recordID=<?php echo $row['Id']; ?>"><img src="../img_menu/editar.png" width="47" height="48" /></a></div>
          </td>
          <td>
