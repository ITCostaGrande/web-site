...
<body>
			...
			<div class="contenedorAccesibilidad" style="top: 5%;">
				<div class="idiomas text-right">
					<a href="https://globalpage-prod.webex.com/join?surl=https%3A%2F%2Fsignin.webex.com%2Fcollabs%2F%23%2Fmeetings%2Fjoinbynumber%3FTrackID%3D%26hbxref%3D%26goid%3Dattend-meeting" title="Microsoft Teams" target="_blank">
						...
						<img loading='lazy' src="./public/img/logos/itcg2.png" alt="ITCostaGrande" class="plecaTECNM" style="width:20%;height:auto; min-width:80px" />
					</a>
	...
	<nav class="navbar navbar-expand-xl navbar-dark" style='background-color: #1B396A;' id="main_navbar">
		...
		<div class="collapse navbar-collapse pl-5 pl-lx-0" id="navbarSupportedContent2">
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
					<li class="nav-item dropdown">
						<a class="dropdown-item" href="/web-site/oferta/presencial">
	...
	<div class="sticky-container">
		<ul class="sticky">
			<li>
				<img loading='lazy' src="./public//img/redes_sociales/facebook.png" width="32" height="32" alt="facebook" />
				<p><a href="https://www.facebook.com/TECNMCostaGrande/" target="_blank">Me gusta en<br>Facebook</a></p>
			</li>
			<li>
				<img loading='lazy' src="./public//img/redes_sociales/twitter.png" width="32" height="32" alt="Twitter" />
				<p><a href="https://twitter.com/it_costagrande" target="_blank">Síguenos en<br>Twitter</a></p>
			</li>
			<li>
				<img loading='lazy' src="./public//img/redes_sociales/youtube.png" width="32" height="32" alt="YouTube" />
...
<img src="./public/img/botoncontacto/contacto.png" onmouseover="this.src='./public/img/botoncontacto/contacto2.png';" onmouseout="this.src='./public/img/botoncontacto/contacto.png';" id="Bcontacto"  title="Contactar al Campus ITCostaGrande" onclick="mostrar()" />
...
<div id="formulario">   
  ...
  <h2 align="center" id="titulo">¡Bienvenido!</h2>
	...
	<script src="./public/js/bootnavbar.js"></script>
	<script>
		$(function() {
